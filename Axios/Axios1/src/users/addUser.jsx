      ...
      <div className="addPage">
        <form onSubmit={handledata}>
          <div>
            ...
            <input id="name" type="text" className="person" value={data.name} onChange={(e) => setData({...data, name:e.target.value})} />
            <label htmlFor="username">نام کاربری</label>
            <input id="username" type="text" className="person" value={data.userName}  onChange={(e) => setData({...data, userName:e.target.value})} />
            <label htmlFor="email">ایمیل</label>
            <input id="email" type="email" className="person" value={data.email}  onChange={(e) => setData({...data, email:e.target.value})} />
          </div>
